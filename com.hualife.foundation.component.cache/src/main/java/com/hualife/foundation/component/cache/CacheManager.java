...
public interface CacheManager {
     ...
     * {@link com.hualife.foundation.component.cache.CacheBuilder#build()} is called.
     ...
     * @param cache
     */
    <K, V> void addCache(Cache<K, V> cache);
...
//    UserTransaction getUserTransaction();
     ...
     * When using storeByValue ({@link com.hualife.foundation.component.cache.config.CacheConfiguration#isStoreByValue()}), if keys or values that
...
//    void addImmutableClass(Class<?> immutableClass);
     ...
     * <p/>
     * For each cache in the cache manager the {@link com.hualife.foundation.component.cache.Cache#stop()} method will be invoked, in no guaranteed order.
