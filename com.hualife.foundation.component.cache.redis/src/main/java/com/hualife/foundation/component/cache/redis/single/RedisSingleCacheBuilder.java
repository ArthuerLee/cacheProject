...
public class RedisSingleCacheBuilder<K, V> implements CacheBuilder<K, V> {
	private RedisSingleCache<K,V> cache = new RedisSingleCache<K, V>();
	
	public RedisSingleCacheBuilder(String cacheName){
